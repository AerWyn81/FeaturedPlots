...
public class LanguageHandler {
    ...
    public LanguageHandler(FeaturedPlots main, String language) {
        this.main = main;
    ...
    public String checkLanguage(String lang) {
        File f = new File("plugins/FeaturedPlots/language/messages_" + lang + ".yml");
        if (f.exists())
            return lang;
        return "en";
    }
    ...
    public void pushMessages() {
        File f = new File("plugins/FeaturedPlots/language/messages_" + language + ".yml");
